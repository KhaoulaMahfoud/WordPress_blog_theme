...
class Customize_Image_Radio_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( $this->type, get_template_directory_uri() . '/inc/assets/js/ForBlogs-image-radio.js', array( 'jquery' ), '1.0.0', true );
		wp_enqueue_style( $this->type, get_template_directory_uri() . '/inc/assets/css/ForBlogs-image-radio.css', array(), '1.0.0' );
	}
