...
class Customize_Alpha_Color_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( $this->type, get_template_directory_uri() . '/inc/assets/js/ForBlogs-alpha-color-picker.js', array( 'jquery' ), '1.0.0', true );
		wp_enqueue_style( $this->type, get_template_directory_uri() . '/inc/assets/css/ForBlogs-alpha-color-picker.css', array(), '1.0.0' );
	}
