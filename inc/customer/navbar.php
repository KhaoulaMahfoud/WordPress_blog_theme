<?php
/**
 * ForBlogs theme customizer: Navbar
 *
 * @author Terry Lin
...
function ForBlogs_customize_navbar( $wp_customize ) {
     ...
     * Panel
     */
    $wp_customize->add_panel( 'panel_ForBlogs_navbar',
        array(
            'title'    => __( 'Navbar', 'ForBlogs' ),
            'priority' => 10,
        )
    );
    ...
    $wp_customize->add_section( 'section_homepage_header_navbar',
		array(
			...
			'priority'   => 10,
			'panel'      => 'panel_ForBlogs_navbar',
		)
	);

	$wp_customize->add_section( 'section_header_navbar',
		array(
			'title'      => __( 'Website', 'ForBlogs' ),
			'priority'   => 10,
			'panel'      => 'panel_ForBlogs_navbar',
		)
	);
	...
	$wp_customize->add_control(
		new Customize_Alpha_Color_Control( $wp_customize, 'home_menu_bg_color_control',
			array(
				...
				'description'  => __( 'This option is for homepage only.', 'ForBlogs' ),
	...
	$wp_customize->add_control( 
		new WP_Customize_Color_Control( $wp_customize, 'home_menu_link_hover_color_control', 
			array(
				'label'       => __( 'Link Hover Color', 'ForBlogs' ),
				'description' => __( 'This option is for homepage only.', 'ForBlogs' ),
				'section'     => 'section_homepage_header_navbar',
	...
	$wp_customize->add_control( 
		new Customize_Alpha_Color_Control( $wp_customize, 'home_menu_toggler_border_color_control',
			array(
				'label'        => __( "Menu Toggler's Border Color", 'ForBlogs' ),
				'section'      => 'section_homepage_header_navbar',
				'settings'     => 'navbar_homepage_menu_toggler_border_color',
				'description'  => __( 'It is visible only when the screen width is less than 768px.', 'ForBlogs' ) . ' ' . __( 'This option is for homepage only.', 'ForBlogs' ),
				'show_opacity' => true,
				'palette'	   => $default_color_palette,
			)
		) 
	...
	$wp_customize->add_control( 
		new Customize_Alpha_Color_Control( $wp_customize, 'home_menu_toggler_bg_color_control',
			array(
				'label'        => __( "Menu Toggler's Background Color", 'ForBlogs' ),
				'section'      => 'section_homepage_header_navbar',
	...
	$wp_customize->add_control( 
		new Customize_Alpha_Color_Control( $wp_customize, 'menu_toggler_border_color_control',
			array(
				...
				'show_opacity' => true,
				'palette'	   => $default_color_palette,
				'description'  => __( 'It is visible only when the screen width is less than 768px.', 'ForBlogs' ),
			)
		) 
	);
	...
	$wp_customize->add_control(
		new Customize_Toggle_Control( $wp_customize, 'navbar_is_display_search_bar_control',
			array(
				'label'       => __( 'Display a Search Bar', 'ForBlogs' ),
				'section'     => 'section_header_searchbar',
				'settings'    => 'navbar_is_display_search_bar',
				'description' => __( 'Would you like to display a search bar in header navbar area?', 'ForBlogs' ),
			)
		)
	);
	...
	$wp_customize->add_control( 
		new WP_Customize_Color_Control( $wp_customize, 'searchbar_placeholder_color_control',
			array(
				'label'    => __( 'Placeholder Color', 'ForBlogs' ),
				'section'  => 'section_header_searchbar',
	...
	$wp_customize->add_control( 
		new WP_Customize_Color_Control( $wp_customize, 'searchbar_text_color_control',
			array(
				'label'    => __( 'Input Text Color', 'ForBlogs' ),
				'section'  => 'section_header_searchbar',
