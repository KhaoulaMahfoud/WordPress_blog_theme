<?php
/**
 * Main Customizer in ForBlogs theme.
 *
 * @author Terry Lin
...
add_action( 'customize_register', 'ForBlogs_customize_about' );
add_action( 'customize_register', 'ForBlogs_customize_homepage' );
add_action( 'customize_register', 'ForBlogs_customize_layout' );
add_action( 'customize_register', 'ForBlogs_customize_navbar' );
add_action( 'customize_register', 'ForBlogs_customize_post_card' );
add_action( 'customize_register', 'ForBlogs_customize_post_page' );
add_action( 'customize_register', 'ForBlogs_customize_progress_bar' );