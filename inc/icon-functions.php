<?php
/**
 * Social icon links in ForBlogs theme.
 *
 * @author Terry Lin
 ...
 * @return array
 */
function ForBlogs_social_links_icons() {
 ...
 */
function ForBlogs_nav_menu_social_icons( $item_output, $item, $depth, $args ) {

	// Get supported social icons.
	$social_icons = ForBlogs_social_links_icons();
