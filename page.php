...
<div class="data-schema is-page" itemscope itemtype="<?php ForBlogs_article_schema(); ?>">

	<?php
		/**
		 * Hook: ForBlogs_page_before
		 *
		 * @hooked ForBlogs_post_metadata - 10
		 */
		do_action( 'ForBlogs_page_before' ); 
	?>
					...
					<?php while ( have_posts() ) : ?>
						...
						<article id="post-<?php the_ID(); ?>" <?php post_class( 'markdown-body' ); ?>>
							...
							<div itemprop="articleBody">
								<?php
									/**
									 * Hook: ForBlogs_page_content_before
									 */
									do_action( 'ForBlogs_page_content_before' );

									the_content();

									/**
									 * Hook: ForBlogs_page_content_after
									 */
									do_action( 'ForBlogs_page_content_after' );
	...
	<?php
		/**
		 * Hook: ForBlogs_page_after
		 */
		do_action( 'ForBlogs_page_after' );
	?>
